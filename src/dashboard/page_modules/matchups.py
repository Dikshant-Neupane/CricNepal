            ...
            <div class="card-body" style="display: flex; justify-content: space-between; align-items: center; padding: 32px;">
                <div>
                    ...
                    <div style="display: flex; align-items: baseline; gap: 8px;">
                        <span style="font-size: 64px; font-weight: 700; color: #103b2f; line-height: 1;">78</span>
                        <span style="font-size: 24px; color: #4a5a54;">/ 100</span>
                    </div>
                </div>
                <div style="text-align: right;">
                    <div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(82, 183, 136, 0.1); color: #b7802f; padding: 8px 16px; border-radius: 999px; font-size: 14px; font-weight: 600; border: 1px solid #f6e5c8; margin-bottom: 8px;">
                        <span style="width: 8px; height: 8px; background: #b7802f; border-radius: 50%; display: inline-block;"></span> Favorable to Batter
                    </div>
                    <div style="font-size: 12px; color: #4a5a54;">Data Confidence:<br><span style="font-weight: 600; color: #17231f;">Strong (142 Balls)</span></div>
                </div>
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        with c1:
            ...
            <div class="card" style="height: 100%;">
                <div class="card-body">
                    ...
                    <div style="font-size: 32px; font-weight: 700; color: #103b2f; margin-bottom: 8px;">12.4%</div>
        ...
        with c2:
            ...
            <div class="card" style="height: 100%;">
                <div class="card-body">
                    ...
                    <div style="font-size: 32px; font-weight: 700; color: #103b2f; margin-bottom: 8px;">148.5</div>
                    <div style="font-size: 12px; color: #4a5a54;">+12 over average</div>
                </div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with c3:
            ...
            <div class="card" style="height: 100%;">
                <div class="card-body">
                    ...
                    <div style="font-size: 32px; font-weight: 700; color: #103b2f; margin-bottom: 8px;">32%</div>
