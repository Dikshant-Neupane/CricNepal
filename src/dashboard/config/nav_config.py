"""
Navigation configuration for Janakpur Bolts dashboard.
...
NAV_ITEMS = [
    ...
    # In Progress / Under Construction Modules
    {"icon": "", "label": "Phase & Strength", "key": "phase_analysis"},
...
# Bottom navigation items (Settings, Support)
NAV_BOTTOM = [
